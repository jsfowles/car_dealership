  ...
  pending "add some examples to (or delete) #{__FILE__}"
    ...
    describe 'class methods' do
      before(:each) do
        ...
        @car2 = Car.create(make: 'Honda', model: 'Pilot', price: '10000')
        @car3 = Car.create(make: 'Ford', model: 'Focus', price: '20000')
    ...
    describe 'instance methods' do
      ...
      it 'returns info' do
        expected = {color: 'red', interior: 'blue', milage: 1000, price: 30000}
